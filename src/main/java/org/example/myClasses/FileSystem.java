...
public class FileSystem {
    ...
    private Scanner scanner = new Scanner(System.in);
         ...
         * @throws IOException
         */
    public Vector<Integer, Movie> parseToList(String file) throws IOException {
        ...
        Vector<Integer, Movie> map_one = o.readValue(input, new TypeReference<>(){});
        Vector<Integer, Movie> map = new Vector<>();

        for(Integer keys : map_one.get()){
            Movie group = map_one.get(keys);
            map.put(keys, group);
        }
        fileInit(file);
        return map_one;
